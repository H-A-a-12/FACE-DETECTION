...
while(1):
    ...
    if face_extractor(frame) is not None:
        ...
        file_name_path='C:/Users/Lenovo/Pictures/harsh/user'+str(id)+'.jpg'
        cv2.imwrite(file_name_path,face)
        cv2.putText(face,str(id),(50,50),cv2.FONT_HERSHEY_COMPLEX,1,(0,255,0),2)
        cv2.imshow('face cropper',face)
    else:
        print('face not found')
        pass
    if  cv2.waitKey(1)==13 or id==1:
        break
cap.release()
